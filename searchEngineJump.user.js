...
(function () {
    ...
    function iqxinstart(){
        ...
        var settingData = {
            ...
            "allOpen":false,
            "center":2,
            "engineDetails":[['网页', 'web',true],['翻译', 'translate',true],['知识', 'knowledge',true],['地图', 'map',true],['图片', 'image',true],['视频', 'video',true],['音乐', 'music',true],['学术', 'scholar',false],  ['社交', 'sociality',true],['购物', 'shopping',true],["新闻","news",false],['mine', 'mine',false]],
            "engineList":{},
